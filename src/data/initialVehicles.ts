...
export function createInitialVehicles(): Vehicle[] {
  ...
  const medSafeRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.MED_SAFE?.distanceKm || 7.5,
    estimatedDurationMin: roadGeometries.MED_SAFE?.durationMin || 14,
    compositeRiskScore: 18,
    dangerZonesCount: 0,
    whyRejectedOrChosen: '✓ SELECTED: Max stability index (18%). Heavy concrete retaining walls and wide shoulders. All-weather safe for emergency vaccine transport.',
  ...
  const medDangerRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.MED_DANGER?.distanceKm || 7.5,
    estimatedDurationMin: (roadGeometries.MED_DANGER?.durationMin || 14) + 45,
  ...
  const grainSafeRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.GRAIN_SAFE?.distanceKm || 12.5,
    estimatedDurationMin: roadGeometries.GRAIN_SAFE?.durationMin || 22,
  ...
  const grainDangerRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.GRAIN_DANGER?.distanceKm || 14.7,
    estimatedDurationMin: (roadGeometries.GRAIN_DANGER?.durationMin || 26) + 55,
  ...
  const fuelSafeRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.FUEL_SAFE?.distanceKm || 7.3,
    estimatedDurationMin: roadGeometries.FUEL_SAFE?.durationMin || 16,
  ...
  const agriSafeRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.AGRI_SAFE?.distanceKm || 17.7,
    estimatedDurationMin: roadGeometries.AGRI_SAFE?.durationMin || 32,
  ...
  const agriDangerRoute: RouteOption = {
    ...
    totalDistanceKm: roadGeometries.AGRI_DANGER?.distanceKm || 19.4,
    estimatedDurationMin: (roadGeometries.AGRI_DANGER?.durationMin || 35) + 70,
